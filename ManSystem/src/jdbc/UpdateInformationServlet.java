...
public class UpdateInformationServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			UpdateInformationBean updateinformationbean=new UpdateInformationBean();
			List<StudentBean> studentbeanlist=new ArrayList<StudentBean>();			
			studentbeanlist = updateinformationbean.getInformation();			
//			System.out.println("12321321321UpdateServ321323131313");
